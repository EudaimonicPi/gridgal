...
// export function usePaginatedCards(itemsPerPage = 5) {
...
//         // Step 1: fetch only first page fast
//         const fetchedCardsJSON = await fetchAll({ limit: itemsPerPage }); 
//         const firstBatch = JSON.parse(fetchedCardsJSON);
...
//         // Step 2: fetch the rest in background
//         setIsBackgroundLoading(true);
//         const fullFetchedJSON = await fetchAll();
//         const fullData = JSON.parse(fullFetchedJSON);

//         if (!cancelled) {
//           setAllCards(fullData);
...
//     isLoading,
//     isBackgroundLoading, // you can show a "loading more..." message somewhere
//   };
// }
